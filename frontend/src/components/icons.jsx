...
export const IcMegaphone = (p) => (<svg {...S(p)}><path d="M3 11v2a1 1 0 0 0 1 1h2l6 4V6L6 10H4a1 1 0 0 0-1 1z" /><path d="M15.5 8.5a4 4 0 0 1 0 7" /></svg>);
...
export const AdsGlyph = ({ s = 28 }) => (<svg width={s} height={s} viewBox="0 0 24 24"><line x1="12.2" y1="5.4" x2="6.8" y2="14.8" stroke="#FBBC04" strokeWidth="5.4" strokeLinecap="round" /><circle cx="5.7" cy="16.7" r="2.7" fill="#34A853" /><line x1="12.2" y1="5.4" x2="18.3" y2="16" stroke="#4285F4" strokeWidth="5.4" strokeLinecap="round" /></svg>);
...
// Shopify: de groene boodschappentas met witte 's'.
export const ShopifyGlyph = ({ s = 28 }) => (<svg width={s} height={s} viewBox="0 0 24 24"><path d="M15.3 3.4c-.2-.1-.5-.1-.6 0l-1 .3c-.4-1-1-1.9-2-1.9h-.1c-.6-.8-1.4-.8-1.9-.5-1.3.7-1.9 2.6-2.2 3.8l-1.7.5c-.5.2-.5.2-.6.7L3.5 20.4 14 22.3l5.7-1.2c0-.1-4.2-17.5-4.4-17.7ZM11.5 4.4l-1.6.5c.3-1.1.8-2 1.6-2.3v1.8Zm-1-2.1c.1 0 .3 0 .4.1-.9.4-1.4 1.5-1.7 2.7l-1.3.4c.3-1.2 1-2.9 2.6-3.2Z" fill="#95BF47" /><path d="M14.7 3.4c-.1-.1-.2 0-.3 0l-.6.2 4.4 17.5L14 22.3V1.9c.3 0 .5.2.7.5.2.3 4.2 17.3 4.2 17.5l-4.2-16.5Z" fill="#5E8E3E" /><path d="M12.8 8.3l-.5 1.6s-.5-.3-1.2-.3c-1 0-1 .6-1 .8 0 .9 2.4 1.3 2.4 3.5 0 1.7-1.1 2.8-2.5 2.8-1.8 0-2.6-1.1-2.6-1.1l.5-1.6s.9.8 1.7.8c.5 0 .7-.4.7-.7 0-1.2-2-1.3-2-3.3 0-1.7 1.2-3.3 3.6-3.3.9 0 1.4.5 1.4.5Z" fill="#fff" /></svg>);
